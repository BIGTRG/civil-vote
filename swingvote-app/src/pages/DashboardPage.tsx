  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/50 text-sm mt-1">SwingVote Election Intelligence Center</p>
      </div>

      {/* Top stats */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white/5 rounded-xl border border-white/10 p-5">
          <div className="text-3xl font-bold text-purple-400">{totalRaces}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/polling" className="text-purple-400 text-xs hover:underline">View All</Link>
          </div>
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/maps" className="text-purple-400 text-xs hover:underline">View Map</Link>
          </div>
          <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/news" className="text-purple-400 text-xs hover:underline">View All</Link>
          </div>
          <div className="space-y-3">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/canvassing" className="text-purple-400 text-xs hover:underline">View All</Link>
          </div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-purple-400">{canvassingStats.contactRate}%</span>
                </div>
                <div className="w-full bg-white/10 rounded-full h-3">
                  <div className="bg-purple-500 h-3 rounded-full" style={{ width: `${canvassingStats.contactRate}%` }} />
                </div>
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <Link key={i} to={link.path} className="bg-white/5 rounded-xl border border-white/10 p-4 hover:border-purple-500/30 transition-colors text-center group">
            <svg className="w-6 h-6 mx-auto mb-2 text-white/30 group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
