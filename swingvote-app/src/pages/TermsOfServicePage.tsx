    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6 text-white/70 leading-relaxed">
        <section>
          ...
          <p>By accessing or using SwingVote (the "Service"), operated by CivilVote Technologies, Inc., you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Service.</p>
        </section>
        ...
        <section>
          ...
          <p>The Service and its original content, features, and functionality are owned by CivilVote Technologies, Inc. and are protected by copyright, trademark, and other intellectual property laws. The SwingVote name, logo, and all related marks are trademarks of CivilVote Technologies, Inc..</p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">SwingVote is a civic engagement and voter information platform. The Service is provided "as is" and "as available" without warranties of any kind, either express or implied.</p>
