...
const TYPE_CONFIG: Record<NotificationType, { label: string; color: string; icon: string }> = {
  ...
  campaign_news: { label: "Campaign", color: "text-purple-400 bg-purple-500/10", icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" },
    ...
    <div className="min-h-screen bg-[#0a1628] text-white p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <button onClick={markAllRead} className="text-sm text-purple-400 hover:underline">
              Mark all as read
            </button>
          )}
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {n.actionUrl && (
                      <a href={n.actionUrl} className={"text-xs mt-2 inline-block text-purple-400 hover:underline"} onClick={e => e.stopPropagation()}>
                        View details
                      </a>
                    )}
                  </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between py-2">
                ...
                <div className={`w-10 h-5 rounded-full transition-all cursor-pointer ${pref.enabled ? "bg-purple-500" : "bg-white/20"}`}>
