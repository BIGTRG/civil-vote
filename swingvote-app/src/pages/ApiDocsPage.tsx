    ...
    <div className="min-h-screen bg-[#0a1628] text-white p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-purple-400 mt-1">Build integrations with CivilVote election data</p>
        </div>

        {/* API Key */}
        <div className="bg-white/5 border border-purple-500/20 rounded-xl p-5 mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <code className="bg-black/30 px-3 py-2 rounded text-sm font-mono text-purple-400">{apiKey}</code>
                    ...
                    <div className="space-y-2">
                      {ep.params.map(p => (
                        <div key={p.name} className="flex items-start gap-3 text-sm">
                          <code className="text-purple-400 font-mono text-xs bg-white/5 px-1.5 py-0.5 rounded">{p.name}</code>
