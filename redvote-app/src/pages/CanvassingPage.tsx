  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {[
          { label: "Total Turfs", value: stats?.totalTurfs || 0, color: "red-400" },
          ...
          { label: "Completed", value: stats?.completedTurfs || 0, color: "red-400" },
        ].map((s, i) => (
                  ...
                  <tr key={turf._id} className="border-b border-white/5 hover:bg-white/5">
                    ...
                    <td className="px-6 py-3">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        ...
                        turf.status === "in_progress" ? "bg-red-500/20 text-red-400" :
