        ...
        <div className="lg:col-span-1">
          <div className="bg-white/5 border border-white/10 rounded-xl p-4">
            ...
            <select value={selected} onChange={e => setSelected(e.target.value)}
              className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-400 mb-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm"><span className="text-white/50">Auto Registration</span><span className="text-red-400 font-semibold">{Object.values(stateData).filter(s => s.autoReg).length}</span></div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href={info.onlineUrl} target="_blank" rel="noopener noreferrer"
                  className="bg-red-600 hover:bg-red-500 text-white rounded-xl p-5 text-center transition-colors">
