    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <input
          ...
          className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white placeholder-white/30 w-64 focus:outline-none focus:border-red-500/50"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.length > 0 ? filtered.map((article) => (
          <a
            ...
            className="bg-white/5 rounded-xl border border-white/10 p-5 hover:border-red-500/30 transition-colors group"
          >
            ...
            <h3 className="text-white font-medium text-sm group-hover:text-red-400 transition-colors line-clamp-2 mb-2">
              {article.title}
            </h3>
