          ...
          return (
            <div key={s} className="flex items-center gap-2">
              <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-medium ${
                isActive ? "bg-red-500 text-white" : isDone ? "bg-red-500/30 text-red-400" : "bg-white/10 text-white/30"
              }`}>
                {isDone ? "\u2713" : i + 1}
              </div>
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={addPriority} disabled={!currentIssue || !currentStance}
                  className="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-medium disabled:opacity-30 hover:bg-red-600">
                  Add
                </button>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={runMatch} disabled={priorities.length === 0 || loading}
              className="bg-red-500 text-white px-6 py-2 rounded-lg text-sm font-medium disabled:opacity-30 hover:bg-red-600">
