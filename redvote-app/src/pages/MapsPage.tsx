    ...
    <div className="space-y-6">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {selectedRatings.length > 0 && (
              <div>
                <h3 className="text-sm font-medium text-red-400 mb-2">Race Ratings</h3>
            ...
            <div>
              <h3 className="text-sm font-medium text-red-400 mb-2">Active Races</h3>
              <div className="space-y-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white/5 rounded-xl border border-white/10 p-4 text-center">
          <div className="text-2xl font-bold text-red-400">{stateRaces.size}</div>
