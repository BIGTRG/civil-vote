...
export function FECFooter() {
  return (
    <footer className="border-t border-red-500/20 bg-black/20 py-4 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs">
            <Link to="/privacy" className="text-white/40 hover:text-red-400 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-white/40 hover:text-red-400 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
