    ...
    <div className="min-h-screen bg-[#0a1628] text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-blue-400 mt-1">Support the candidates and causes you believe in</p>
        </div>
          ...
          <div className="lg:col-span-2">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg pl-8 pr-4 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-blue-500"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg mb-6">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full transition-all ${isRecurring ? "bg-blue-500" : "bg-white/20"}`}
                  >
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    className={"flex-1 py-3 rounded-lg font-bold bg-blue-500 hover:bg-blue-600 text-white"}
                  >
            ...
            {step === 3 && (
              <div className="bg-white/5 border border-white/10 rounded-xl p-8 text-center">
                ...
                <p className="text-blue-400 text-lg mb-2">${finalAmount?.toLocaleString()}{isRecurring ? " monthly " : " "}donation</p>
                ...
                {RECENT_DONATIONS.map((d, i) => (
                  <div key={i} className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      {d.recurring && <p className={"text-xs text-blue-400"}>Monthly</p>}
                    </div>
                  </div>
                ))}
              </div>
