...
function StatCard({ value, label, sub }: { value: string; label: string; sub?: string }) {
  return (
    <div className="bg-[#0d1f3c] border border-white/10 p-5">
      <div className="text-3xl font-bold tracking-tight text-white">{value}</div>
      <div className="text-xs font-medium uppercase tracking-wider text-blue-300/50 mt-1">{label}</div>
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-white/10">
            {headers.map((h, i) => (
              <th key={i} className={`py-2.5 px-3 text-xs font-medium uppercase tracking-wider text-blue-300/50 ${i > 0 ? "text-right" : "text-left"}`}>{h}</th>
            ))}
          </tr>
        </thead>
        <tbody>
...
function OverviewTab() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">Democratic Committee Breakdown -- 2024 Cycle</h3>
        <DataTable
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-[#0d1f3c] border border-white/10 p-5">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">DNC Expenditure Categories</h3>
          <DataTable
        ...
        <div className="bg-[#0d1f3c] border border-white/10 p-5">
          <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">DNC State Partnership Program</h3>
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">2026 Midterm Spending Projections</h3>
        <DataTable
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 p-4 text-sm text-blue-200">
...
function NationalTab() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">Top DNC Vendor Payments (2024)</h3>
        <DataTable
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">vs. Republican Committees (Comparison)</h3>
        <DataTable
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">ActBlue Fundraising Platform</h3>
        <div className="space-y-3 text-sm text-white/70">
          <div className="flex justify-between py-2 border-b border-white/5">
...
function StateTab() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">Priority Democratic State Parties -- 2026 Gubernatorial</h3>
        <DataTable
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">State Spending Projections (2026)</h3>
        <div className="space-y-3 text-sm text-white/70">
          <div className="flex justify-between py-2 border-b border-white/5">
          ...
          <div className="flex justify-between py-2">
            ...
            <span className="font-mono text-blue-400 text-xs">democrats.org/state-parties</span>
          </div>
        </div>
      </div>
    </div>
...
function VendorTab() {
  return (
    <div className="space-y-6">
      <div className="bg-[#0d1f3c] border border-blue-500/20 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-400 mb-4">DNC "I Will Run" Marketplace -- Vendor Application</h3>
        <div className="space-y-3 text-sm text-white/80">
          ...
          <div className="mt-3 p-4 bg-white/5">
            <div className="text-xs uppercase tracking-wider text-blue-300/50 mb-2">Contact</div>
            <div className="font-mono text-blue-400">tech-ecosystem@dnc.org</div>
            <div className="mt-3 text-xs uppercase tracking-wider text-blue-300/50 mb-2">Categories for BlueVote</div>
            <div>Voter Contact, Digital, Finance</div>
            <div className="mt-3 text-xs uppercase tracking-wider text-blue-300/50 mb-2">Required Pricing</div>
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">Application Steps</h3>
        <div className="space-y-4 text-sm text-white/70">
          <div className="p-3 bg-white/5">
            <div className="text-xs uppercase tracking-wider text-blue-300/40 mb-1">Step 1 -- Initial Contact</div>
          ...
          <div className="p-3 bg-white/5">
            <div className="text-xs uppercase tracking-wider text-blue-300/40 mb-1">Step 2 -- Product Review</div>
            <div>DNC tech team reviews security (2FA, encryption), uptime (99% min), data privacy, election season support</div>
          </div>
          <div className="p-3 bg-white/5">
            <div className="text-xs uppercase tracking-wider text-blue-300/40 mb-1">Step 3 -- Contract</div>
            <div>Negotiate standard rate + DNC-discounted rate. Free tier for down-ballot. Data sharing requirements.</div>
          </div>
          <div className="p-3 bg-white/5">
            <div className="text-xs uppercase tracking-wider text-blue-300/40 mb-1">Step 4 -- Onboarding</div>
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">ActBlue Integration Strategy</h3>
        <div className="text-sm text-white/70 space-y-2">
          <p>Do not compete with ActBlue. Embed ActBlue donation forms into BlueVote. Campaigns keep their ActBlue account; BlueVote adds the engagement layer.</p>
          <DataTable
      ...
      <div className="bg-[#0d1f3c] border border-white/10 p-5">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-blue-300/50 mb-4">Revenue Model -- SaaS Vendor</h3>
        <DataTable
