    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6 text-white/70 leading-relaxed">
        <section>
          ...
          <p>BlueVote is operated by CivilVote Technologies, Inc. ("BlueVote," "we," "us," or "our"). This Privacy Policy describes how we collect, use, disclose, and protect your personal information when you use our platform, website, and mobile application (collectively, the "Service").</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">2. Information We Collect</h2>
          <p className="mb-2"><span className="text-blue-400 font-medium">Information you provide:</span> Name, email address, mailing address, phone number, date of birth, voter registration status, political preferences (optional), and any other information you voluntarily submit.</p>
          <p className="mb-2"><span className="text-blue-400 font-medium">Account information:</span> Login credentials, profile settings, and communication preferences.</p>
          <p className="mb-2"><span className="text-blue-400 font-medium">Transaction data:</span> If you make purchases or donations through the Service, we collect billing information, transaction history, and payment details (processed through secure third-party payment processors).</p>
          <p><span className="text-blue-400 font-medium">Automatically collected:</span> IP address, browser type, device information, operating system, referring URLs, pages visited, time spent on pages, and cookies/similar technologies.</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><span className="text-blue-400 font-medium">Service providers</span> who assist in operating the platform (hosting, analytics, payment processing)</li>
            <li><span className="text-blue-400 font-medium">Legal authorities</span> when required by law, subpoena, or government request</li>
            <li><span className="text-blue-400 font-medium">Business transfers</span> in connection with a merger, acquisition, or sale of assets</li>
            <li><span className="text-blue-400 font-medium">With your consent</span> when you explicitly authorize sharing</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><span className="text-blue-400 font-medium">Access:</span> Request a copy of the personal data we hold about you</li>
            <li><span className="text-blue-400 font-medium">Correction:</span> Request that we correct inaccurate or incomplete data</li>
            <li><span className="text-blue-400 font-medium">Deletion:</span> Request that we delete your personal data</li>
            <li><span className="text-blue-400 font-medium">Opt-out:</span> Opt out of marketing communications at any time</li>
            <li><span className="text-blue-400 font-medium">Portability:</span> Request your data in a portable format</li>
          </ul>
