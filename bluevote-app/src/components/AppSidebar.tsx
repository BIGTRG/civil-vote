...
export function AppSidebar({ onNavigate }: { onNavigate?: () => void } = {}) {
  return (
    <aside className="w-64 h-full bg-[#0a1628] border-r border-white/5 flex flex-col">
      {/* Logo */}
      ...
      <nav className="flex-1 p-4 space-y-6 overflow-y-auto">
        {navItems.map(group => (
          <div key={group.group}>
            <div className="text-xs font-medium text-blue-300/30 uppercase tracking-wider mb-2 px-3">
              {group.group}
            </div>
