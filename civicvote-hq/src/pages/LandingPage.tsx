        ...
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          {showAuthActions && !isAuthenticated && !isLoading && (
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base h-12 px-8 border-[#0F2A4A]/20"
                asChild
              >
          ...
          {showAuthActions && isAuthenticated && (
            <div className="pt-2">
              <Button
                size="lg"
                className="text-base h-12 px-8 bg-[#0F2A4A] hover:bg-[#1A3D66]"
                asChild
              >
                <Link to="/dashboard">
                  Go to Dashboard
              ...
              <div className="relative">
                ...
                {showAuthActions && (
                  <Button
                    size="sm"
                    variant="secondary"
                    className="bg-white text-[#0F2A4A] hover:bg-white/90"
                    asChild
                  >
                    <Link to="/signup">
                      Enter HQ
